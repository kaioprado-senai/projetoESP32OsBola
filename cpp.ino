...
float diametroRoda = 0.1;
float circunferenciaRoda = diametroRoda * 3.141592;
float kph = 0;
float rpm = 0;
...
if (tempoAtual - tempoUltimoPulso > 1000) {
if (!primeiroPulso) {
...
kph = (circunferenciaRoda * pulsosPorSegundo) * 3.6;
}
...
String dadosRequisicao = "velocidade=" + String(kph, 2) + "&rpm=" + String(rpm,
2);
